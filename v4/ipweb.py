...
# !! Simpan referensi asli SEBELUM monkey-patch apapun !!
# Kalau tidak, _LatestFrame.__init__ akan panggil versi ter-patch
# → rekursi tak terbatas → RecursionError
...
class _LatestFrame:
    ...
    def __init__(self, url: str):
        self._cap   = _real_VideoCapture(url)   # ← pakai asli, BUKAN cv2.VideoCapture
        self._frame = None
...
def main():
    ...
    # Uji koneksi dulu sebelum run_webcam (pakai original, bukan patch)
    test = _real_VideoCapture(video_url)
    ...
    print("✓ Stream kamera HP terhubung (low-latency mode)\n")
